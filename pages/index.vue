  ...
  <ClientOnly>
    <UContainer class="flex flex-wrap justify-center gap-4 py-4">
      <UCard
        ...
        :ui="{
          base: [
            'relative z-0 w-full max-w-xs text-gray-900 dark:text-white',
            'pointer-events-none'
          ],
      ...
      >
        ...
        <ULink
          :class="[
            'text-base font-semibold truncate focus-visible:outline-none',
            'pointer-events-auto before:absolute before:inset-0 before:-z-[1]'
          ]"
          :to="link.to"
        >
          {{ link.label }}

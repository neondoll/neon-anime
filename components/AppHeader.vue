...
<template>
  <header
    :class="[
      'sticky top-0 z-50 -mb-px bg-white/75 dark:bg-gray-900/75 border-b border-gray-200 dark:border-gray-800',
      'backdrop-blur'
    ]"
  >
    <UContainer class="flex justify-between items-center gap-3 py-4">
      <div class="lg:flex-1 flex items-center gap-1.5">
        <ULink class="flex-shrink-0 flex items-end gap-1.5 text-xl font-bold text-gray-900 dark:text-white"
